...
Find additonal and alternative use cases for the PCB within [Uses directory](https://github.com/SamGowland/Gowla-Macro-Board/tree/master/Uses). A good example is [dan-r](https://github.com/dan-r) IR Remote use case. 
